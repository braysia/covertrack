...
input_parent_dir = join(ROOTDIR, 'data', 'ktr_images', 'IL1B', 'Pos008')
output_parent_dir = join(ROOTDIR, 'output', 'IL1B')
...
postprocess_args = (dict(name='gap_closing'),
                    dict(name='cut_short_traces', minframe=59))
# Subdetection
subdetect_args = (dict(name='ring_dilation_above_offset_buffer', object_name='cytoplasm',
                       seed_obj='nuclei', ch_img='TRITC', RINGWIDTH=5, BUFFER=4, OFFSET=200, FILSIZE=100), )
